(function($) {
	...
	SAMLmetaJS.plugins.conext = {
		...
		setUp: function () {
			...
			conextHTML += '<fieldset id="contract"><legend>Contract & Licensing</legend>' +
			...
			conextHTML += '<fieldset id="experience"><legend>Previous Install</legend>' +
					...
					'<label for="yes_previous_install">Yes, I or my organisation has previously installed and/or maintains a SAML2 based Service Provider</label>' +
					'</br>' +					
					'<input type="checkbox" id="no_previous_install" name="no_previous_install" />' +
					'<label for="no_previous_install">No, I/We are new to this whole SAML2 based Service Provider thing</label>' +
					'</fieldset>';
